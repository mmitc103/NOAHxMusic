...
from NOAHxMusic.utils.decorators.admins import ActualAdminCB
from NOAHxMusic.utils.decorators.language import language, languageCB
from NOAHxMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from NOAHxMusic.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://te.legra.ph/file/bc7a6757bfbccd08d8de2.mp4"),
