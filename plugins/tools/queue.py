...
from NOAHxMusic.utils import HottyBin, get_channeplayCB, seconds_to_min
from NOAHxMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from NOAHxMusic.utils.decorators.language import language, languageCB
from NOAHxMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://te.legra.ph/file/b0099ea8b851b9f31cccb.jpg",
        caption=_["queue_1"],
    )
